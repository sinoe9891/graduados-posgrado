<footer class="page-footer">
    <div class="container">
      <div class="row">
        ...
        <div class="col l3 s12">
          <h3 class="white-text">Enlaces Rápidos</h3>
          <ul>
    ...
    <div class="footer-copyright">
      <div class="container">
      <p style="color:white;">© <?php echo date('Y');?> <a class="grey-text text-lighten-4" href="https://www.zamorano.edu">Universidad Zamorano1.</a> All Rights Reserved.</p>
      </div>
    </div>
